            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-md-12 form-color p-4 shadow-sm">
                        <div class="row mb-3">
                            <div class="col-10">
                                <h4 class="pb-1">Codigos postales</h4>
                            </div>
                            ...
                            <div class="col-1">
                                <a href="<?= constant('URL'); ?>postcodes" class="btn btn-secondary">
                                ...
                                <div class="table-responsive">
                                    <table id="dataTable" class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <span><?= $postcode->state; ?></span>
                                                </td>

                                                <td>
                                                    <span><?= $postcode->municipality; ?></span>
                                                </td>

                                                <td>
                                                    <span><?= $postcode->colony; ?></span>
                                                </td>
                                                ...
                                                <td class="align-middle">
                                                    <a href="<?= constant('URL') . 'postcodes/delete?id=' . $postcode->id_postcode; ?>" class="status-span badge-primary badge-delete">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title title-register" id="exampleModalLongTitle">
                        <?= $_SESSION['name']; ?>, registra un codigo postal
                    </h5>
                ...
                <div class="modal-body mx-auto">
                    ...
                    <form method="POST" action="<?= constant('URL'); ?>postcodes/register">
                        ...
                        <div class="form-group">
                            ...
                            <input id="postcode" type="text" value="<?= $this->error['postcode']; ?>" name="postcode" class="form-control <?= $this->error['c4']; ?>" maxlength="5" minlength="5" required>
